  ...
  <div  class="collapse navbar-collapse design " id="collapsibleNavbar">
    ...
    <div class="row">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="col-sm-2">
        <li class="nav-item">
        <a class="nav-link" href="./php-signup-login/index.php">TÀI KHOẢN</a>
        </li>
        </div>
      ...
      <header >
            ...
            <div class="action-button one_fourth last" style="margin-top:2%; ">
              <a href="tel:0396422172">
                  <h4 class="themebutton">039.642.172</h4>
              </a>
          </div>
    ...
    <article class="container">
      <div class="row">
          <div class="col-sm-6 ">
            <hr>
              <p style="font-size:20px; font-family: Calibri;"> <br>Ít nhất một lần trong đời ai cũng từng gặp phải trường hợp xe bị hỏng hóc buộc phải tìm đến nơi sửa xe. Thật là đau buồn biết bao! Tìm Gara sửa xe hay Trạm bơm xăng dầu trong lúc nguy cấp đâu có dễ nhỉ? Vì vậy, Chúng tôi ở đây để giảm bớt toàn bộ gánh nặng của bạn trong việc tìm Gara sửa và Trạm xăng trong trường hợp xe bạn gặp sự cố.</p>
          ...
          <div class="col-sm-6 col-lg-6 col-md-6  img-fluid ">
            <img src="./assets/image/car1.jpg" alt="breakdown" >
          </div>
      </div>
    <br><br>
    </article>
...
<!-- Guide-->
  ...
  <section style="text-align: center ;" id="service">
      <hr>
    <h3><span style="color: coral; font-family: 'Dancing Script', cursive;" ><strong>HƯỚNG DẪN SỬ DỤNG</strong></span>
      <br><br>
      </h3>
  </section>
    ...
    <div class="row">
        <div class="col-12 col-md-4" style="background-color: gainsboro;margin-left: 0.2em; margin-bottom: 0.5em;">
        <p><span style="color:red;">Tìm Kiếm Trạm Xăng Gần Nhất:</span><br><br>Bạn có thể tìm kiếm các trạm xăng gần nhất tại Việt Nam.<br><br>
          Tại trang web của chúng tôi, tất cả các trạm xăng dầu tại Việt Nam đều năm trong tầm tay của bạn.<br>
        </p>

        </div>
        <div class="col-12 col-md-3 "style="background-color: gainsboro; margin-left: 0.2em;margin-bottom: 0.5em;">
        <p><span style="color:purple;">Tìm Kiếm Gara Gần Nhất:</span>
          ...
          <div class="col-12 col-md-4"style="background-color: gainsboro;margin-left: 0.2em;margin-bottom: 0.5em;">
        <p style="color:green;">Bảng Giá Dịch Vụ:
          <br><br> 
...
<!-- Map your bussiness-->
  <div class="row">
      <div class="col-sm-6">
          <p style="font-size:27px;"> <br><b style="color: darkorange; font-family: 'Dancing Script', cursive; margin-left:7em; "> Công Ty Alo Cứu Hộ 14 </b><br>
              <div id="map" style="width:500px;height:500px;margin-left:8em;">
...
<br><br>
    <footer class="foooter-background" id="about">
          <div class="container">
              ...
              <div class="col-12 col-sm-4" style="padding-bottom:3em; ">
                <span style="color: coral;font-size:23px; font-family: 'Dancing Script', cursive;">  Về Chúng Tôi:</span>
                  <br><br>
                  Chúng tôi là những sinh viên IT bình thường<br>
                  <br>Với khát vọng đạt điểm tối đa của môn Công Nghệ Phần Mềm này.
        ...
        <p style="text-align: center;font-family: 'Dancing Script', cursive;font-size: 1.1em;"> © 2022 AloCuuHo14 - All rights reserved </p>
    </footer>
